...
public class ZWAggregationBuilder {
    ...
    public static AvgBuilder avgBuilder(String name, String field) {
     ...
     * 添加terms聚合构建
     */
    public static TermsBuilder termsAggregationBuilder(String name, String field, Integer size, boolean ifAsc, String sortBy) {
